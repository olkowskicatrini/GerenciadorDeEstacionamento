        ...
        () => controller.isLoading.value
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(
                      'Vaga ${controller.listParkingSpotObs[index].parkingSpotNumber}: Placa ${controller.listParkingSpotObs[index].licensePlateCar}',
                    ),
                    subtitle: Text(
                      'Responsável: ${controller.listParkingSpotObs[index].responsibleName}',
                    ),
                    trailing: Row(
